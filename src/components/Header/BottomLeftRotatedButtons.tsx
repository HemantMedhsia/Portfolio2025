...
const BottomLeftRotatedButtons: React.FC = () => {
    ...
    return (
        <>
            <div className="flex gap-4 text-[20px] fixed bottom-60 -left-45 z-40 -rotate-90">
                ...
                }} className="bg-white/10 backdrop-blur-md border border-indigo-400 text-indigo-200 font-medium px-5 py-2 rounded-bl-xl rounded-br-xl shadow-lg hover:bg-indigo-200/60 hover:text-black transition-all duration-300 tracking-widest cursor-pointer">
                    MY PROJECTS
                </button>
            </div>
        </>
