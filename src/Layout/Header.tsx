...
const Header: React.FC = () => {
    ...
    return (
        <motion.div>
            <motion.div
                className="fixed top-4 md:top-10 left-1/2 transform -translate-x-1/2 w-full max-w-4xl h-16 px-4 md:px-6 flex items-center justify-between 
                md:rounded-3xl backdrop-blur-3xl bg-[#15161C]/50 border-2 border-[#2A2B37] z-50 overflow-hidden"
            >
                <LogoSection />
                <SocialIcons />
